...
//    ApplicationContext context;
    ...
    /**
     *
     * Method to set the ApplicationContext that this object runs in to
     * initialize the object using dependency injection.
     *
     * Dependency injection helps to bind independent components together
     * without using the new operator.
     *
     * Spring provides an ApplicationContextAware interface that allows beans
     * access to the ApplicationContext e.g. if your bean needs to look up some
     * other beans.
     */
